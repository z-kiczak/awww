...
def scrape_website_content(url):
    ...
    try:
        ...
        par = soup.find('p')
        if par and len(par.text.strip()) > 300:
...
def create_language_subsites(rank, logo, lang, rating, change):
    ...
    additional_info = fetch_additional_info(f"{lang} programming language description")
    ...
    try:
        ...
        if table_content:
            ...
            for rank, logo, lang, rating, change in table_content[:5]:
                # Account for the special characters
